...
|编号|预处理手段|线下AUC测评分数|线上AUC分数|代码版本|数据版本|
|:--:|:--:|:--:|:--:|:--:|:--:|
|1|引入train_inter进行分析，并根据train_pulic预测train_inter，并从train_inter中选取满足条件的样本来扩充train_public数据集|0.983422|**0.88547781**|baseline_20211002_2200|mysub_20211002_2340_seed8341|
